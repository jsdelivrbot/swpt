...
$(function () {
    $(".qiyetab .l-tab-links li:first-child").click(function(e){
        e.preventDefault();
        $("html").css("overflow", "hidden");
        $("#maincontents").attr("src", zizhanguanli_gnUrl)
        console.log($(".sbs").contents().find("html").height());
        $("#gn").css("display", "block")
    })
    $(".qiyetab .l-tab-links li:last-child").click(function(e){
        // var works_lcUrl = 'http://192.168.0.251:8080/rapid_dev/toActivitiIndex.do?id="+id+"&name="+name';
        e.preventDefault();
        $("html").css("overflow", "hidden");
        $("#maincontents").attr("src", zizhanguanli_lcUrl)
        $("#gn").css("display", "block")
    })
    $(".qiyetab .l-tab-links li:first-child").trigger("click")
})
/*$( document ).ready( function () {
    $(document).on("click", ".qiyetree>li:first-child>div:first-child", function () {
        //alert(2)
    });
    $(".qiyetree>li:first-child>div:first-child").trigger("click");
})*/
