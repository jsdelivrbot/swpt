...
var FormManageComponent = (function () {
    function FormManageComponent(http, httpData, insertData) {
        ...
        this.nodeMenuItem = [
            { action: __WEBPACK_IMPORTED_MODULE_2_ng2_tree__["NodeMenuItemAction"].Custom, name: '新建PC网页', cssClass: 'fa fa-cog fa-desktop' },
            { action: __WEBPACK_IMPORTED_MODULE_2_ng2_tree__["NodeMenuItemAction"].Custom, name: '新建手机页', cssClass: 'fa fa-cog fa-mobile' },
...
var HttpDataService = (function () {
    function HttpDataService() {
        ...
        var localHost = "192.168.0.213";
        //const localHost = '88878240.dd8w.com';
                    ...
                    switch (dataType) {
                        case 'text':
                            ...
                            showData = "<input name='leipiNewField' type='" + data.type + "' datasource='" + data.datasource + "' orgbghide='" + data.orgbghide + "'" +
                                ...
                                (" maxlength='" + data.maxlength + "' orgdisabled='" + data.orgdisabled + "'  " + disabled + "  >");
                            break;
                        case 'textarea':
                            disabled = data.orgdisabled === '1' ? 'disabled' : '';
                        ...
                        case 'listctrl':
                            ...
                            break;
                        case 'addimage':
                            showData = "<input name=leipiNewField orgpicheight='" + data.orgpicheight + "' orgpicwidth='" + data.orgpicwidth + "'" +
                        ...
                        case 'formlist':
                            ...
                            break;
                        case 'wxgrouptag':
                            showData = "<input name=\"leipiNewField\" type=\"text\" title=\"\u5FAE\u4FE1\u5206\u7EC4\u6807\u7B7E\" value=\"\u5FAE\u4FE1\u5206\u7EC4\u6807\u7B7E\" msgflag=\"" + data.msgflag + "\" leipiplugins=\"wxgrouptag\" style=\"width: 90px;height: 30px;\"/>";
                            break;
                        case "onlinehard":
                        case "workword":
                        case "workform":
