 ...
 * @example
 * ```javascript
 * editor.execCommand( 'reportforms');
 * ```
 */

UE.plugins['reportforms'] = function () {
    var me = this,thePlugins = 'reportforms';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/reportforms.html',
                name:thePlugins,
                editor:this,
                title: '报表控件',
                cssRules:"width:800px;height:400px;",
    ...
    me.addListener( 'mouseover', function( t, evt ) {
        ...
        if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
            var html = popup.formatHtml(
                '<nobr>报表控件: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
            if ( html ) {
                popup.getDom( 'content' ).innerHTML = html;
                popup.anchorEl = el;
                popup.showAnchor( popup.anchorEl );
 ...
 * @example
 * ```javascript
 * editor.execCommand('chart');
 * ```
 */

UE.plugins['chart'] = function () {
    var me = this,thePlugins = 'chart';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + 'formdesign' +'/chart.html',
                name:thePlugins,
                editor:this,
                title: '图表控件',
                cssRules:"width:800px;height:400px;",
    ...
    me.addListener( 'mouseover', function( t, evt ) {
        ...
        if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
            var html = popup.formatHtml(
                '<nobr>图表控件: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
            if ( html ) {
                popup.getDom( 'content' ).innerHTML = html;
                popup.anchorEl = el;
                popup.showAnchor( popup.anchorEl );
 ...
 * @example
 * ```javascript
 * editor.execCommand( 'iconrouter');
 * ```
 */

UE.plugins['iconrouter'] = function () {
    var me = this,thePlugins = 'iconrouter';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/iconrouter.html',
                name:thePlugins,
                editor:this,
                title: '图标路由控件',
                cssRules:"width:800px;height:400px;",
    ...
    me.addListener( 'mouseover', function( t, evt ) {
        ...
        if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
            var html = popup.formatHtml(
                '<nobr>图标路由控件: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
            if ( html ) {
                popup.getDom( 'content' ).innerHTML = html;
                popup.anchorEl = el;
                popup.showAnchor( popup.anchorEl );
