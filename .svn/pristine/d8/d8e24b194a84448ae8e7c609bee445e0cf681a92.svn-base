!function($, wysi) {
    ...
    var tpl = {
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn" + size + "' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "'><i class='icon-home'></i></a>" +
                "<a class='btn" + size + "' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "'><i class='icon-th-home'></i></a>" +
    ...
    var locale = $.fn.wysihtml5.locale = {
        en: {
            ...
            lists: {
                unordered: "Unordered home",
                ordered: "Ordered home",
                outdent: "Outdent",
                indent: "Indent"
            },
            link: {
